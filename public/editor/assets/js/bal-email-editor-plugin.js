...
$(data).find('table').css('background');
if($(data).find('table').css('background'))
{
    console.log('ho sfondo');
}
            ...
            generate: function(elementsHtml) {
                ...
                if (_this.config.showSettingsBar == true) {
                    ...
                    // _settings += '<li class="bal-setting-item goBack" data-toggle="tooltip" title="Torna al CRM">' +
                ...
                _tabProperty = '<div class="tab-property bal-element-tab">' +
                    ...
                    '<li class="bal-elements-accordion-item" data-type="variables">' +
                    '<a class="bal-elements-accordion-item-title">Variabili</a>' +
                    '<div class="bal-elements-accordion-item-content">' +
                    '<div class="bal-social-content-box ">' +
                    '<label>Url</label>' +
                    '<input type="text" class="variables-url" setting-type="">' +
                    '</div>' +
                    '</div>' +
                    '  </li>' +
            ...
            events_of_setting: function() {
                ...
                jQuery('#popup_images').on('click', '.btn-select', function(event) {
                    ...
                    _url = jQuery('.modal').find('.upload-image-item.active').attr('data-url');
            ...
            tinymceContextMenu: function() {
                ...
                if (_this.config.showContextMenu_Variables == true) {
                    _toolBar += 'variables ';
                }

                //default options
                _toolBar += ' | alignleft aligncenter alignright alignjustify | bullist numlist | forecolor backcolor |  unlink removeformat  | extra';
                tinymce.init({
                    ...
                    link_class_list: [
                       {title: 'None', value: ''},
                       {title: 'Tracciabile', value: 'trackable'}
                   ],
                    setup: function(ed) {
                       ed.addButton('extra', {
                           icon:'user',
                          title: 'Extra',
                          onclick: function() {
                             ed.insertContent(' %%%contact.fullname%%% ');
                          }
                       });
        ...
        $.fn.emailBuilder = function(options) {
            ...
            this.setShowContextMenu_Variables = function(showContextMenu_Variables) {
                _emailBuilder.config.showContextMenu_Variables = showContextMenu_Variables;
            }
