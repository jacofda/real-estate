<table class="main" width="100%" cellspacing="0" cellpadding="0" border="0"
   ...
   style="background-color:#FFFFFF" align="center">
    <tbody>
        <tr>
            <td class="element-content button-1" align="left" style="padding-left:50px;padding-right:50px;padding-top:10px;padding-bottom:10px;font-family:Arial;font-size:13px;color:#808080;line-height:22px;">
