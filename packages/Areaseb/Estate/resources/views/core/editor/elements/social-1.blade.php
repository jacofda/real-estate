            ...
            <td class="element-content social-content" style="padding:20px 50px;text-align:center">
                ...
                @else
                    ...
                    <a href="#insta3" style="border: none;display: inline-block;margin-top: 10px;" class="instagram">
                        <img border="0" alt="instagram" src="{{asset('editor/assets/images/social-icons/instagram-01.png')}}" width="32">
                    </a>
                    <a href="#" style="border: none;display: inline-block;margin-top: 10px;" class="pinterest">
                        <img border="0" alt="pinterest" src="{{asset('editor/assets/images/social-icons/pinterest-01.png')}}" width="32">
                    </a>
                    <a href="#" style="border: none;display: inline-block;margin-top: 10px;" class="facebook">
                        <img border="0" alt="facebook" src="{{asset('editor/assets/images/social-icons/facebook-01.png')}}" width="32">
                    </a>
                    <a href="#" style="border: none;display: inline-block;margin-top: 10px;" class="twitter">
                        <img border="0" alt="twitter" src="{{asset('editor/assets/images/social-icons/twitter-01.png')}}" width="32">
                    </a>
                    <a href="#" style="border: none;display: inline-block;margin-top: 10px;" class="linkedin">
                        <img border="0" alt="linkedin" src="{{asset('editor/assets/images/social-icons/linkedin-01.png')}}" width="32">
                    </a>
                    <a href="#" style="border: none;display: inline-block;margin-top: 10px;" class="youtube">
                        <img border="0" alt="youtube" src="{{asset('editor/assets/images/social-icons/youtube-01.png')}}" width="32">
                    </a>
