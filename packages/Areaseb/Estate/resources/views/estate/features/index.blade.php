...
@include('estate::layouts.elements.title', ['title' => 'Caratteristiche'])
                ...
                <div class="card-header bg-secondary-light">
                    <div class="card-tools">
                        <div class="btn-group" role="group">
                            <a class="btn btn-primary creable" href="#" data-model="Feat" data-field="name_it"><i class="fas fa-plus"></i> Crea Caratteristica</a>
                        </div>
                        ...
                        <table class="table table-sm table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach($features as $feat)
                                    <tr id="row-{{$feat->id}}" data-model="Feat" data-id="{{$feat->id}}">
                                        <td class="property-editable" data-field="name_it">{{$feat->name_it}}</td>
                                        <td class="property-editable" data-field="name_en">{{$feat->name_en}}</td>
                                        <td>
                                            {{$feat->properties()->count()}}
                                        </td>
                                        <td>

                                            {!! Form::open(['method' => 'delete', 'url' => route('features.destroy', $feat->id), 'id' => "form-".$feat->id]) !!}
                                                <button type="submit" id="{{$feat->id}}" class="btn btn-danger btn-icon btn-sm delete"><i class="fa fa-trash"></i></button>
                                            {!! Form::close() !!}
