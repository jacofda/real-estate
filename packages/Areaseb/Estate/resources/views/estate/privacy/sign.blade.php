...
<body>
    <div class="container">
        <h1>Firma la privacy</h1>
        <div class="row">
            <div class="col-12">
                <h4>Rivedi la privacy generata prima di firmarla</h4>
                <iframe class="w-full" style="height: 65vh" src="{{ route('privacy.preview', ['uuid' => $privacy->uuid]) }}" frameborder="0"></iframe>
            </div>
        </div>
        <div class="row">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('privacy.sign', ['uuid' => $privacy->uuid]) }}" method="POST" id="sign-form">
                        @csrf
